  ...
  return (
    <>
      <div className="relative mb-4">
        <input
          className="peer h-10 w-full border-b-[1px] border-gray-300 bg-transparent text-gray-900 placeholder-transparent focus:border-b-[2.5px] focus:border-yellow-400 focus:outline-none dark:border-gray-500 dark:bg-transparent dark:text-gray-50"
          {...rest}
        />
        <label
          htmlFor={htmlFor}
